        ...
        <div className="container">
          <div>
            <div className="w-[560px] bg-white shadow-[#00000059_0px_5px_15px] box-border mx-auto my-16 py-10 rounded-3xl">
              ...
              <form className="w-full flex flex-col px-20 gap-[18px] mb-[15px]">
                <input
                  type="email"
                  className="border box-border px-[15px] py-3 rounded-3xl border-solid border-[#c0c0c0]"
                ...
                <button className="text-lg font-semibold font-nunitoFont text-slate-50 shadow-[#0000003d_0px_3px_8px] bg-navegrey border cursor-pointer p-[0.625em] rounded-[20px] border-navegrey hover:text-navegrey hover:bg-[white] hover:transition-[0.5s] hover:border-solid hover:border-navegrey">
                  Log in
                </button>
              </form>
